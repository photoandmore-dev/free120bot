...
def process_feedback(message):
    ...
    feedback_text = (
        f"Новое сообщение от @{user.username or user.first_name} (id: {user.id}):\n\n"
        f"{text}"
    )

    # Отправляем в группу в нужный thread_id
    bot.send_message(
